          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-3 opacity-70">
                <button type="button" disabled className="rounded-xl border border-[var(--color-border)] bg-[var(--color-accent-soft)] px-4 py-2 text-xs font-semibold text-[var(--color-text-muted)]">
